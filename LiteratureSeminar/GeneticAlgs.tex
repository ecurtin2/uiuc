...
\begin{frame}{Selecting Parents}
	\begin{columns}[c] % align columns
		...
		\begin{column}{0.48\textwidth}
		    \begin{overprint}
			    \onslide<5>\includegraphics[width=\linewidth]{images/pie0.PNG}
				\onslide<6>\includegraphics[width=\linewidth]{images/pie1.PNG}
				\onslide<7>\includegraphics[width=1.1\linewidth]{images/pie2.PNG}
			\end{overprint}
		\end{column}	
	\end{columns}
\end{frame}
